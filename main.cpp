...
Escolhas escolha()
{
    ...
    cout << "\nMenu:" << endl
         ...
         << "Opção: ";
    cin >> menuescolha;
    return (Escolhas) menuescolha;
}
//------------------------------------------------------------------------
void criarposicoes(fstream &f)
{
...
void Listardespesa(fstream &f)
{
    ...
    cout<<"Valor total de despesas: "<<cont;
}
//------------------------------------------------------------------------
void gravararquivo(fstream &f)
{
    despesa c;
...
int main()
{
    ...
    while ((opcao = escolha()) != FIM)
    {
        switch (opcao)
        {
        case CRIAR:
            criarposicoes(inOutDespesas);
            break;
        case TELA:
            Listardespesa(inOutDespesas);
            break;
        case ARQUIVOTEXTO:
            gravararquivo(inOutDespesas);
            break;
        case ATUALIZAR:
            Alterar(inOutDespesas);
            break;
        case NOVO:
            cadastrar(inOutDespesas);
            break;
        case APAGAR:
            excluirdespesa(inOutDespesas);
            break;
        default:
